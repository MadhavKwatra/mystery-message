        ...
        <div className="px-4 py-3 space-y-1">
          {session ? (
            <Button
              ...
              className="w-full  font-semibold bg-slate-100 text-gray-900 py-2 px-4 rounded mt-2"
            >
              Logout
            </Button>
          ) : (
            <Link href="/sign-in">
              <Button className="w-full font-semibold bg-slate-100 text-gray-900 py-2 px-4 rounded mt-2">
                Login
              </Button>
            </Link>
          )}
